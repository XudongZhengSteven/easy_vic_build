...
from JRB_build_dpc import dataProcess_VIC_level0_JRB, dataProcess_VIC_level1_JRB, dataProcess_VIC_level2_CDMet_JRB, dataProcess_VIC_level3_JRB
...
from easy_vic_build.tools.dpc_func.basin_grid_func import createEmptyArray_from_gridshp, createArray_from_gridshp, assignValue_for_grid_array, createEmptyArray_and_assignValue_from_gridshp


class buildParam_level0_interface_JRB(buildParam_level0_interface):
...
class buildParam_level1_interface_JRB(buildParam_level1_interface):
    ...
    def set_annual_prec(self):
        ...
        self.grid_shp_level1["annual_P_all_data_mean_mm"] = self.grid_shp_level1.loc[:, ["annual_P_CDMet_mm", "annual_P_CMADSV1_mm", "annual_P_CMFD_mm"]].mean(axis=1)
        
        self.grid_array_annual_P = assignValue_for_grid_array(
            self.grid_array_annual_P,
            self.grid_shp_level1.loc[:, "annual_P_all_data_mean_mm"],
...
def build_params_JRB(station_name, model_scale, reverse_lat=True):
    # build evb
    ...
    # build parameters
    default_params_JRB = default_params
    default_params_JRB["g_params"]["soil_layers_breakpoints"] = {
        "default": [2, 4],
        "boundary": [[0, 2], [2, 4]],
        "type": int,
        "optimal": [2, 4],
