...
def combine_MODIS_NDVI_data(reverse_lat=True, type="mean", rstr=r"A\d{7}", date_period=["2008", "2018"]):
    src_home = (
        "E:\\data\\hydrometeorology\\MODIS\\MOD13A3 v061_NDVI_EVI_monthly_1km\\JRB\\data"
    )
    
    dst_home = (
        "E:\\data\\hydrometeorology\\MODIS\\MOD13A3 v061_NDVI_EVI_monthly_1km\\JRB"
    )
...
def reproject_MODIS_NDVI_data(type="mean", date_period=["2008", "2018"]):
    src_home = (
        "E:\\data\\hydrometeorology\\MODIS\\MOD13A3 v061_NDVI_EVI_monthly_1km\\JRB"
    )
    dst_home = src_home
...
def gapfillingNDVI(type="mean", date_period=["2008", "2018"]):
    src_home = (
        "E:\\data\\hydrometeorology\\MODIS\\MOD13A3 v061_NDVI_EVI_monthly_1km\\JRB"
    )
    dst_home = src_home
...
def ExtractData(
    ...
    NDVI_home = (
        "E:\\data\\hydrometeorology\\MODIS\\MOD13A3 v061_NDVI_EVI_monthly_1km\\JRB\\2008_2018"
    )
    NDVI_path = os.path.join(
        NDVI_home, "combine_data_2008_2018_months_mean_reproject_filled.tif"
    )
    NDVI_max_path = os.path.join(
        NDVI_home, "combine_data_2008_2018_months_max_reproject_filled.tif"
    )
    NDVI_min_path = os.path.join(
        NDVI_home, "combine_data_2008_2018_months_min_reproject_filled.tif"
    )
...
if __name__ == "__main__":
    # combine_MODIS_NDVI_data(reverse_lat=True, type="min")
    # reproject_MODIS_NDVI_data(type="max")
    # gapfillingNDVI(type="max")
    pass
