...
def copy_rvic_result_to_case_dir(evb_dir_modeling, case_dir, save_type="cali", suffix=1):
    suffix_all = save_type + str(suffix)
    ...
    RVIC_flow_direction = os.path.join(evb_dir_modeling.RVICParam_dir, "flow_direction_file.nc")
    shutil.copy(RVIC_flow_direction, os.path.join(case_dir, "flow_direction_file.nc"))

    RVIC_param_cfg = os.path.join(evb_dir_modeling.RVICParam_dir, "rvic.parameters.cfg")
    shutil.copy(RVIC_param_cfg, os.path.join(case_dir, "rvic.parameters.cfg"))
...
def calibrate_HRB(evb_dir_modeling):
    ...
    # nsgaII set
    algParams_NSGAII = {"popSize": 20, "maxGen": maxGen, "cxProb": 0.9, "mutateProb": 0.15}
    
    # CMA_ES set
    algParams_CMA_ES = {"popSize":20, "maxGen": maxGen, "sigma": 0.5}
    ...
    # params_case1["g_params"] = g_params_Nijssen_spatially_uniform_minimal
    ...
    params_case3["rvic_params"]["VELOCITY"]["free"] = False
    params_case3["rvic_params"]["DIFFUSION"]["free"] = False
    params_case3["guh_params"]["tp"]["free"] = False
    params_case3["guh_params"]["mu"]["free"] = False
    params_case3["guh_params"]["m"]["free"] = False
    rvic_spatial_case3 = False
    buildParam_level0_interface_class = buildParam_level0_interface_HRB
    ...
    # case_name = "case5"
    # params_case5 = deepcopy(params_minimal)
    # params_case5["g_params"] = set_g_params_soilGrids_layer(params_case5["g_params"])
    # params_case5["g_params"] = expand_station_wise_params(params_case5["g_params"], station_num=len(station_names))
    # params_case5["rvic_params"] = rvic_params_spatial
    # rvic_spatial_case5 = True
    # buildParam_level0_interface_class = buildParam_level0_interface_HRB
    ...
    # case_name = "case6"
    # params_case6 = deepcopy(params_minimal)
    # params_case6["g_params"] = g_params_Nijssen_spatially_uniform_minimal
    # params_case6["g_params"] = set_g_params_soilGrids_layer(params_case6["g_params"])
    # params_case6["rvic_params"]["VELOCITY"]["free"] = False
    # params_case6["rvic_params"]["DIFFUSION"]["free"] = False
    # params_case6["guh_params"]["tp"]["free"] = False
    # params_case6["guh_params"]["mu"]["free"] = False
    # params_case6["guh_params"]["m"]["free"] = False
    # rvic_spatial_case6 = False
    ...
    # case_name = "case7"
    # params_case7 = deepcopy(params_minimal)
    # params_case7["g_params"] = g_params_Nijssen_spatially_uniform_minimal
    # params_case7["g_params"] = set_g_params_soilGrids_layer(params_case7["g_params"])
    # rvic_spatial_case7 = False
    ...
    # case_name = "case8"
    # params_case8 = deepcopy(params_minimal)
    # params_case8["g_params"] = set_g_params_soilGrids_layer(params_case8["g_params"])
    # params_case8["g_params"] = expand_station_wise_params(params_case8["g_params"], station_num=len(station_names))
    # params_case8["rvic_params"] = rvic_params_spatial
    # rvic_spatial_case8 = True
    ...
    param_temp = params_case3
    rvic_spatial = rvic_spatial_case3
    basin_hierarchy = basin_hierarchy  # basin_hierarchy
    Baseflow_scheme = "NIJSSEN2001"  #  Baseflow_scheme
    ...
    # simulate rvic compare
    simulate_rvic_compare_case3_runoff_base = False
    if simulate_rvic_compare_case3_runoff_base:
        # mkdir
        case_dir = os.path.join(evb_dir_modeling.CalibrateVIC_dir, "case_rvic_params_compare_case3_runoff_base", case_name)
        check_and_mkdir(case_dir)
        ...
        rvic_spatial_case3 = False
        buildParam_level0_interface_class = buildParam_level0_interface_HRB
        evb_dir_modeling.calibrate_cp_path = evb_dir_modeling.calibrate_cp_path.replace("_case3.pkl", f"_case3.pkl")
        Baseflow_scheme = "NIJSSEN2001"
        cali_method = "NSGAII"
        basin_hierarchy = None
        ...
        # get ind
        first_num_data = get_inds_NSGAII(evb_dir_modeling, ind_num=1, max_num=maxGen)
        ind = first_num_data["first_num_best_ind"][0]

        # sim vic
        sim_right_vic = cali_algorithm.simulate_vic(ind)

        # sim rvic
        simulate_rvic = cali_algorithm.simulate_rvic(ind)
        copy_rvic_result_to_case_dir(evb_dir_modeling, case_dir, save_type="cali", suffix=0)
        ...
        params_case2["g_params"] = set_g_params_soilGrids_layer(params_case2["g_params"])
        rvic_spatial_case2 = False
        evb_dir_modeling.calibrate_cp_path = evb_dir_modeling.calibrate_cp_path.replace("_case3.pkl", f"_case2.pkl")
        basin_hierarchy = None
        buildParam_level0_interface_class = buildParam_level0_interface_HRB
        Baseflow_scheme = "NIJSSEN2001"
        cali_method = "NSGAII"

        param_temp = params_case2
        rvic_spatial = rvic_spatial_case2
        basin_hierarchy = basin_hierarchy  # basin_hierarchy
        Baseflow_scheme = "NIJSSEN2001"  #  Baseflow_scheme
        params_cali = ParamManager(param_temp)
        logger.info(f"calibrate param: {params_cali.vector_names(get_free=True)}")
        ...
        # sim rvic
        case_dir = os.path.join(evb_dir_modeling.CalibrateVIC_dir, "case_rvic_params_compare", case_name)
        check_and_mkdir(case_dir)
        simulate_rvic = cali_algorithm.simulate_rvic(ind)
        copy_rvic_result_to_case_dir(evb_dir_modeling, case_dir, save_type="cali", suffix=0)
        ...
        rvic_spatial_case4 = True
        buildParam_level0_interface_class = buildParam_level0_interface_HRB
        evb_dir_modeling.calibrate_cp_path = evb_dir_modeling.calibrate_cp_path.replace("_case2.pkl", f"_case4.pkl")
        Baseflow_scheme = "NIJSSEN2001"
        cali_method = "NSGAII"
        basin_hierarchy = None
    ...
    # simulate rvic compare
    simulate_rvic_compare_case4_runoff_base = True
    if simulate_rvic_compare_case4_runoff_base:
        # mkdir
        case_name = "case4"
        case_dir = os.path.join(evb_dir_modeling.CalibrateVIC_dir, "case_rvic_params_compare_case4_runoff_base", case_name)
        check_and_mkdir(case_dir)
        ...
        rvic_spatial_case4 = True
        buildParam_level0_interface_class = buildParam_level0_interface_HRB
        evb_dir_modeling.calibrate_cp_path = evb_dir_modeling.calibrate_cp_path.replace("_case3.pkl", f"_case4.pkl")
        Baseflow_scheme = "NIJSSEN2001"
        cali_method = "NSGAII"
        basin_hierarchy = None
        ...
        rvic_spatial_case3 = False
        buildParam_level0_interface_class = buildParam_level0_interface_HRB
        evb_dir_modeling.calibrate_cp_path = evb_dir_modeling.calibrate_cp_path.replace("_case4.pkl", f"_case3.pkl")
        Baseflow_scheme = "NIJSSEN2001"
        cali_method = "NSGAII"
        basin_hierarchy = None
