...
def combine_MODIS_LAI_data(reverse_lat=True, rstr=r"A\d{7}", date_period=["2003", "2018"]):
    src_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB\\data"
    dst_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB"
    suffix = ".hdf"
...
def reproject_MODIS_LAI_data(date_period=["2003", "2018"]):
    src_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB"
    dst_home = src_home
...
def gapfillingLAI(date_period=["2003", "2018"]):
    src_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB"
    dst_home = src_home
...
def resampleLAI(date_period=["2003", "2018"], scale_factor=1/2):
    src_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB"
    dst_home = src_home
...
def ExtractData(
    ...
    LAI_home = "E:\\data\\hydrometeorology\\MODIS\\MOD15A2H v061_LAI_FPAR_8day_500m_2000_02_18_to_Present\\HRB\\2003_2018"
    LAI_path = os.path.join(
        LAI_home, "combine_data_2003_2018_months_reproject_filled_resampled_1km.tif"
    )
