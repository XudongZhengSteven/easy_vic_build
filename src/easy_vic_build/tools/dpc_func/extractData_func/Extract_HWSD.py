...
"""Module ``easy_vic_build.tools.dpc_func.extractData_func.Extract_HWSD``."""
...
def inquireHWSDSoilData(MU_GLOBALS):
    # connect
    """
    Run ``inquireHWSDSoilData`` data processing routine.
    
    Parameters
    ----------
    MU_GLOBALS : object
        Input value for ``MU_GLOBALS``.
