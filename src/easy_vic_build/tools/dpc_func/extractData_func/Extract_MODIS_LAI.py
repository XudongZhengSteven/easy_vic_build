...
"""Module ``easy_vic_build.tools.dpc_func.extractData_func.Extract_MODIS_LAI``."""
...
def combine_MODIS_LAI_data(reverse_lat=True):
    """
    Run ``combine_MODIS_LAI_data`` data processing routine.
    
    Parameters
    ----------
    reverse_lat : object, optional
        Input value for ``reverse_lat``.
...
def reproject_MODIS_LAI_data():
    """
    Run ``reproject_MODIS_LAI_data`` data processing routine.
...
def gapfillingLAI():
    """
    Run ``gapfillingLAI`` data processing routine.
...
def ExtractData(
    ...
    ----------
    grid_shp : object
        Input value for ``grid_shp``.
    grid_shp_res : object, optional
        Input value for ``grid_shp_res``.
    plot_month : object, optional
        Input value for ``plot_month``.
    save_original : object, optional
        Input value for ``save_original``.
    check_search : object, optional
        Input value for ``check_search``.
