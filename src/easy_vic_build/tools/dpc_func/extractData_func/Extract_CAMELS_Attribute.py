...
"""Module ``easy_vic_build.tools.dpc_func.extractData_func.Extract_CAMELS_Attribute``."""
...
def readBasinAttribute_CAMELS(
    ...
    """
    Run ``readBasinAttribute_CAMELS`` data processing routine.
    
    Parameters
    ----------
    home : object, optional
        Input value for ``home``.
    dir_camels_attribute : object, optional
        Input value for ``dir_camels_attribute``.
