...
def readStreamflow(hru_id_list=None):
    ...
    Parameters
    ----------
    hru_id_list : object, optional
        Input value for ``hru_id_list``.
...
def ExtractData(basin_shp, read_dates=None):
    ...
    ----------
    basin_shp : object
        Input value for ``basin_shp``.
    read_dates : object, optional
        Input value for ``read_dates``.
...
def checkStreamflowMissing(usgs_streamflow, date_period=["19980101", "20101231"]):
    ...
    Parameters
    ----------
    usgs_streamflow : object
        Input value for ``usgs_streamflow``.
    date_period : object, optional
