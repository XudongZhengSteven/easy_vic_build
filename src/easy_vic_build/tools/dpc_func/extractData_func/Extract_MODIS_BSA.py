...
"""Module ``easy_vic_build.tools.dpc_func.extractData_func.Extract_MODIS_BSA``."""
...
def combine_MODIS_BSA_data():
    ...
    """
    Run ``combine_MODIS_BSA_data`` data processing routine.
...
def combineThreeData():
    """
    Run ``combineThreeData`` data processing routine.
...
def gapfillingBSA():
    """
    Run ``gapfillingBSA`` data processing routine.
