...
def hydroanalysis_wbw(
    ...
    if create_stream:
        ...
        stream_raster_shp_gdf = raster_to_shp(
            os.path.join(workspace_dir, "stream_raster.tif"),
            os.path.join(workspace_dir, "stream_raster_shp.shp"),
        )
        ...
        )  # We only want the streams output
