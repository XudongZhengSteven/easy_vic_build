...
def buildMeteForcing(
    ...
    while year <= end_year:
        ...
        with Dataset(dst_path_year, "w") as dst_dataset:
            ...
            dst_dataset.variables["time"][:] = cftime.date2num(
                time_datetime, units=time_v.units, calendar=time_v.calendar
            )
            ...
            dst_dataset.note = (
                "meteForcing dataset generated by XudongZheng, zhengxd@sehemodel.club"
            )
