...
from .tools.hydroanalysis_func import (create_dem, create_flow_distance,
                                       hydroanalysis_arcpy, hydroanalysis_wbw)
from .tools.utilities import remove_and_mkdir


def buildHydroanalysis(
    evb_dir,
    ...
    if flow_direction_pkg == "arcpy":
        ...
        arcpy_python_script_path = os.path.join(
            evb_dir.__package_dir__, "arcpy_scripts\\build_flowdirection_arcpy.py"
        )
        ...
        out = hydroanalysis_arcpy.hydroanalysis_arcpy(
            workspace_dir,
            dem_level1_tif_path,
            arcpy_python_path,
        ...
        shutil.copy(
            os.path.join(workspace_dir, "flow_direction.tif"), flow_direction_path
        )
        ...
        out = hydroanalysis_wbw.hydroanalysis_wbw(
            workspace_dir,
            dem_level1_tif_path,
